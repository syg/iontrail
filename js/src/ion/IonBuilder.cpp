...
bool
IonBuilder::getSingleCallTarget(uint32 argc, jsbytecode *pc, MutableHandleFunction target,
                                bool *isClone)
{
...
bool
IonBuilder::getPolyCallTargets(uint32 argc, jsbytecode *pc, AutoObjectVector &targets,
