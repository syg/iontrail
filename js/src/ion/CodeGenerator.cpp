...
CodeGenerator::visitOutOfLineParLambda(OutOfLineParLambda *ool)
{
    ...
    // visitParLambda above) assumes that scopeChain will live long
    // enough to be used for initialization.  Since the scopeChain is
    // currently passed and held in a CallTempReg (which may be
